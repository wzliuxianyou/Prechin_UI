...
struct rt_device_graphic_ops
{
    void (*set_pixel) (rt_uint32_t color, int x, int y);
    void (*get_pixel) (rt_uint32_t color, int x, int y);
    void (*draw_hline)(rt_uint32_t color, int x1, int x2, int y);
    void (*draw_vline)(rt_uint32_t color, int x, int y1, int y2);
    void (*blit_line) (rt_uint32_t color, int x, int y, rt_size_t size);
};
#endif
