...
{
		/**************************************************
	  * Function: Auto unmount filesystem when usb insert.
	  * add by wzlxy 2023.3.17
		***************************************************/
		extern void fileSystem_unmount(void);
		fileSystem_unmount();
		/*************************************/
    struct mstorage *data;
    RT_ASSERT(func != RT_NULL);
...
static rt_err_t _function_disable(ufunction_t func)
{
    ...
    data->status = STAT_CBW;
		/**************************************************
	  * Function: Auto mount filesystem when usb Exit.
	  * add by wzlxy 2023.3.17
		***************************************************/
		extern void fileSystem_mount(void);
		fileSystem_mount();
		/*************************************/
