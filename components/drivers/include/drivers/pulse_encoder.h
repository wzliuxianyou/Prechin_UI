...
/**** add by lxy ******/
#define PULSE_ENCODER_CMD_GET_DIRECTTION (128 + 4)    /* get pulse_encoder direction */
...
struct rt_pulse_encoder_ops
{
	...
	/**** add by lxy ******/
	rt_err_t (*get_direction)(struct rt_pulse_encoder_device *pulse_encoder, void *args);	
};
