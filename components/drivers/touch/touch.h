...
/********************************
*add by lxy 2023-4-25
**********************************/ 
#define RT_TOUCH_VENDOR_IO               (3)  /* FTxx series */
...
*add by lxy 2023-4-25
**********************************/ 
#define  RT_TOUCH_TYPE_MUXIO       		 (3)  /* resistance ic */
...
*add by lxy 2023-4-25
**********************************/ 
#define  RT_TOUCH_CTRL_SET_FLASH		 (10)   /* save parameter */
#define  RT_TOUCH_CTRL_CLEAR			11

/********************************
*add by lxy 2023-4-25
**********************************/ 
#define  RT_MUXIO_CTRL_SET_IO        	 (8)   /* Enable interrupt */
#define  RT_MUXIO_CTRL_CLEAR_IO        	 (9)   /* Enable interrupt */
